...
export default {
  ...
  methods: {
    ...
    async login () {
      ...
      await axios
        .post('http://parchegramtest.com/api/User/UserExists', loginRequest)
        .then(result => {
          if (result.data.data === true) {
            axios
              .get(`http://parchegramtest.com/api/User/EmailConfirmed/${this.loginModel.NameUser}`)
              .then(result => {
                if (result.data.data === true) {
                  axios
                    .post('http://parchegramtest.com/api/User/Login', loginRequest)
                    .then(result => {
